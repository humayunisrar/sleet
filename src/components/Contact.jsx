  ...
  return (
    <section id="contact" className={`flex flex-col justify-center items-center gap-10 py-20`}>
      <div className='flex flex-col gap-2'>
        <h2 className='font-normal uppercase text-[40px] text-magenta'>Have some questions?</h2>
      ...
      <div className='flex flex-row'>
        <div className={`flex ${styles.flexCenter} md:my-0 my-10 relative`}>
          <img src={contact} alt="hero" className="w-[100%] h-[100%] relative z-[5]" />
        </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <input
                ...
                className="border text-magenta border-opacity-50 rounded-md py-2 px-3 w-full"
                required
              />
            </div>
            <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                className="border text-magenta border-opacity-50 rounded-md py-2 px-3 w-full h-32"
                required
              />
            </div>
            <button type="submit" className="bg-magenta text-white rounded-md py-2 px-4 hover:bg-[#00C8BC]">
              Submit
            </button>
          </form>
          {/* End Form */}
